...
impl Qdc {
    ...
    #[doc = "Input Monitor."]
    #[inline(always)]
    pub const fn imr(self) -> crate::pac::common::Reg<Imr, crate::pac::common::R> {
    ...
    #[inline(always)]
    pub const fn ucomp(self) -> crate::pac::common::Reg<Ucomp, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x24usize) as _) }
    }
    #[doc = "Lower Position Compare."]
    #[inline(always)]
    pub const fn lcomp(self) -> crate::pac::common::Reg<Lcomp, crate::pac::common::RW> {
    ...
    #[doc = "Control 3."]
    #[inline(always)]
    pub const fn ctrl3(self) -> crate::pac::common::Reg<Ctrl3, crate::pac::common::RW> {
...
impl Ctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn rev(&self) -> RevDir {
        let val = (self.0 >> 10usize) & 0x01;
        RevDir::from_bits(val as u8)
    }
    #[doc = "Enable Reverse Direction Counting."]
    #[inline(always)]
    pub const fn set_rev(&mut self, val: RevDir) {
...
impl Ctrl2 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn updpos(&self) -> Updpos {
        let val = (self.0 >> 1usize) & 0x01;
        Updpos::from_bits(val as u8)
    }
    #[doc = "Update Position Registers."]
    #[inline(always)]
...
impl RevDir {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> RevDir {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for RevDir {
    #[inline(always)]
    fn from(val: u8) -> RevDir {
        RevDir::from_bits(val)
    }
}
impl From<RevDir> for u8 {
    #[inline(always)]
    fn from(val: RevDir) -> u8 {
        RevDir::to_bits(val)
    }
}
#[repr(u8)]
