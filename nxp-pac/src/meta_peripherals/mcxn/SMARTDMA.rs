...
impl Smartdma {
    ...
    #[inline(always)]
    pub const fn break_addr(self) -> crate::pac::common::Reg<BreakAddr, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x30usize) as _) }
    }
    #[doc = "Breakpoint Vector."]
    #[inline(always)]
    pub const fn break_vect(self) -> crate::pac::common::Reg<BreakVect, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x34usize) as _) }
    }
    #[doc = "Emergency Vector."]
    #[inline(always)]
    pub const fn emer_vect(self) -> crate::pac::common::Reg<EmerVect, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x38usize) as _) }
    }
    #[doc = "Emergency Select."]
    #[inline(always)]
    pub const fn emer_sel(self) -> crate::pac::common::Reg<EmerSel, crate::pac::common::RW> {
