...
impl Rrcr1 {
    #[doc = "Channel Input Enable in Trigger Mode."]
    #[must_use]
    #[inline(always)]
    pub const fn rr_chen(&self, n: usize) -> bool {
        assert!(n < 8usize);
    ...
    #[doc = "Channel Input Enable in Trigger Mode."]
    #[inline(always)]
    pub const fn set_rr_chen(&mut self, n: usize, val: bool) {
        assert!(n < 8usize);
        let offs = 0usize + n * 1usize;
...
impl core::fmt::Debug for Rrcr1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Rrcr1")
            .field("rr_chen[0]", &self.rr_chen(0usize))
            .field("rr_chen[1]", &self.rr_chen(1usize))
            .field("rr_chen[2]", &self.rr_chen(2usize))
            .field("rr_chen[3]", &self.rr_chen(3usize))
            .field("rr_chen[4]", &self.rr_chen(4usize))
            .field("rr_chen[5]", &self.rr_chen(5usize))
            .field("rr_chen[6]", &self.rr_chen(6usize))
            .field("rr_chen[7]", &self.rr_chen(7usize))
...
impl defmt::Format for Rrcr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Rrcr1 {{ rr_chen[0]: {=bool:?}, rr_chen[1]: {=bool:?}, rr_chen[2]: {=bool:?}, rr_chen[3]: {=bool:?}, rr_chen[4]: {=bool:?}, rr_chen[5]: {=bool:?}, rr_chen[6]: {=bool:?}, rr_chen[7]: {=bool:?}, fixp: {:?}, fixch: {:?} }}",
            self.rr_chen(0usize),
            self.rr_chen(1usize),
            self.rr_chen(2usize),
            self.rr_chen(3usize),
...
impl Rrcsr {
    #[doc = "Comparison Result for Channel."]
    #[must_use]
    #[inline(always)]
    pub const fn rr_chout(&self, n: usize) -> bool {
        assert!(n < 8usize);
        let offs = 0usize + n * 1usize;
        let val = (self.0 >> offs) & 0x01;
        val != 0
    ...
    #[doc = "Comparison Result for Channel."]
    #[inline(always)]
    pub const fn set_rr_chout(&mut self, n: usize, val: bool) {
        assert!(n < 8usize);
        let offs = 0usize + n * 1usize;
        self.0 = (self.0 & !(0x01 << offs)) | (((val as u32) & 0x01) << offs);
    }
...
impl core::fmt::Debug for Rrcsr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Rrcsr")
            .field("rr_chout[0]", &self.rr_chout(0usize))
            .field("rr_chout[1]", &self.rr_chout(1usize))
            .field("rr_chout[2]", &self.rr_chout(2usize))
            .field("rr_chout[3]", &self.rr_chout(3usize))
            .field("rr_chout[4]", &self.rr_chout(4usize))
            .field("rr_chout[5]", &self.rr_chout(5usize))
            .field("rr_chout[6]", &self.rr_chout(6usize))
            .field("rr_chout[7]", &self.rr_chout(7usize))
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Rrcsr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Rrcsr {{ rr_chout[0]: {=bool:?}, rr_chout[1]: {=bool:?}, rr_chout[2]: {=bool:?}, rr_chout[3]: {=bool:?}, rr_chout[4]: {=bool:?}, rr_chout[5]: {=bool:?}, rr_chout[6]: {=bool:?}, rr_chout[7]: {=bool:?} }}",
            self.rr_chout(0usize),
            self.rr_chout(1usize),
            self.rr_chout(2usize),
            self.rr_chout(3usize),
            self.rr_chout(4usize),
            self.rr_chout(5usize),
            self.rr_chout(6usize),
            self.rr_chout(7usize)
        )
    }
}
#[doc = "Round Robin Status."]
...
impl Rrsr {
    #[doc = "Channel Input Changed Flag."]
    #[must_use]
    #[inline(always)]
    pub const fn rr_chf(&self, n: usize) -> bool {
        assert!(n < 8usize);
        let offs = 0usize + n * 1usize;
        let val = (self.0 >> offs) & 0x01;
        val != 0
    ...
    #[doc = "Channel Input Changed Flag."]
    #[inline(always)]
    pub const fn set_rr_chf(&mut self, n: usize, val: bool) {
        assert!(n < 8usize);
        let offs = 0usize + n * 1usize;
        self.0 = (self.0 & !(0x01 << offs)) | (((val as u32) & 0x01) << offs);
    }
...
impl core::fmt::Debug for Rrsr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Rrsr")
            .field("rr_chf[0]", &self.rr_chf(0usize))
            .field("rr_chf[1]", &self.rr_chf(1usize))
            .field("rr_chf[2]", &self.rr_chf(2usize))
            .field("rr_chf[3]", &self.rr_chf(3usize))
            .field("rr_chf[4]", &self.rr_chf(4usize))
            .field("rr_chf[5]", &self.rr_chf(5usize))
            .field("rr_chf[6]", &self.rr_chf(6usize))
            .field("rr_chf[7]", &self.rr_chf(7usize))
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Rrsr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Rrsr {{ rr_chf[0]: {=bool:?}, rr_chf[1]: {=bool:?}, rr_chf[2]: {=bool:?}, rr_chf[3]: {=bool:?}, rr_chf[4]: {=bool:?}, rr_chf[5]: {=bool:?}, rr_chf[6]: {=bool:?}, rr_chf[7]: {=bool:?} }}",
            self.rr_chf(0usize),
            self.rr_chf(1usize),
            self.rr_chf(2usize),
            self.rr_chf(3usize),
