...
impl Lpi2c {
    ...
    #[inline(always)]
    pub const fn mtcbr(self, n: usize) -> crate::pac::common::Reg<Mtcbr, crate::pac::common::W> {
        assert!(n < 128usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn mtdbr(self, n: usize) -> crate::pac::common::Reg<Mtdbr, crate::pac::common::W> {
        assert!(n < 253usize);
        unsafe {
...
impl defmt::Format for Mtdbr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Mtdbr {{ data[0]: {=u8:?}, data[1]: {=u8:?}, data[2]: {=u8:?}, data[3]: {=u8:?} }}",
            self.data(0usize),
            self.data(1usize),
            self.data(2usize),
            self.data(3usize)
