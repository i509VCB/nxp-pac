...
impl Scg {
    ...
    #[inline(always)]
    pub const fn apll_ovrd(self) -> crate::pac::common::Reg<ApllOvrd, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x05f4usize) as _) }
    }
    ...
    #[inline(always)]
    pub const fn spll_ovrd(self) -> crate::pac::common::Reg<SpllOvrd, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x06f4usize) as _) }
    }
...
impl Firccfg {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn range(&self) -> FirccfgRange {
        let val = (self.0 >> 0usize) & 0x01;
        FirccfgRange::from_bits(val as u8)
    }
    #[doc = "Frequency Range."]
    #[inline(always)]
    pub const fn set_range(&mut self, val: FirccfgRange) {
...
impl Sosccfg {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn range(&self) -> SosccfgRange {
        let val = (self.0 >> 4usize) & 0x03;
        SosccfgRange::from_bits(val as u8)
    }
    #[doc = "SOSC Range Select."]
    #[inline(always)]
    pub const fn set_range(&mut self, val: SosccfgRange) {
...
impl Spllctrl {
    ...
    pub const fn source(&self) -> SpllctrlSource {
        let val = (self.0 >> 25usize) & 0x03;
        SpllctrlSource::from_bits(val as u8)
    }
    #[doc = "Clock Source."]
    #[inline(always)]
