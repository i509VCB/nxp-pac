...
impl Itrc0 {
    ...
    #[inline(always)]
    pub const fn status1(self) -> crate::pac::common::Reg<Status1, crate::pac::common::RW> {
    ...
    #[inline(always)]
    pub const fn sw_event0(self) -> crate::pac::common::Reg<SwEvent0, crate::pac::common::W> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0xf0usize) as _) }
    }
    #[doc = "Software event 1."]
    #[inline(always)]
    pub const fn sw_event1(self) -> crate::pac::common::Reg<SwEvent1, crate::pac::common::W> {
...
impl OuTxSel {
    ...
    #[inline(always)]
    pub const fn out_sel(
        self,
        n: usize,
    ) -> crate::pac::common::Reg<OutSel, crate::pac::common::RW> {
        assert!(n < 2usize);
        unsafe {
...
impl OuTxSel1 {
    ...
    pub const fn out_sel_1(
        self,
        n: usize,
    ) -> crate::pac::common::Reg<OutSel1, crate::pac::common::RW> {
        assert!(n < 2usize);
        unsafe {
            crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize + n * 4usize) as _)
        }
...
impl OuTxSel2 {
    ...
    pub const fn out_sel_2(
        self,
        n: usize,
    ) -> crate::pac::common::Reg<OutSel2, crate::pac::common::RW> {
        assert!(n < 2usize);
        unsafe {
            crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize + n * 4usize) as _)
        }
...
impl Status1 {
    ...
    pub const fn in24_21_status(&self) -> In2421Status {
        ...
        In2421Status::from_bits(val as u8)
    }
    #[doc = "INTM interrupt monitor error 3~0 event occurred."]
    #[inline(always)]
    ...
    pub const fn in32_25_status(&self) -> In3225Status {
        ...
        In3225Status::from_bits(val as u8)
    }
    #[doc = "MSF SOCTRIM 7~0 ECC error event occurred."]
    #[inline(always)]
