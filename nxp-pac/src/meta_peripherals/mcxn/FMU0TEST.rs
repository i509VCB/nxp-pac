...
impl Fmu0test {
    ...
    #[inline(always)]
    pub const fn rd_data(
        self,
        n: usize,
    ) -> crate::pac::common::Reg<RdData, crate::pac::common::RW> {
        assert!(n < 4usize);
        unsafe {
            crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x014cusize + n * 4usize) as _)
        }
    }
    #[doc = "Parity Register."]
    #[inline(always)]
    ...
    #[doc = "SMW DIN Register."]
    #[inline(always)]
    pub const fn smw_din(
        self,
        n: usize,
    ) -> crate::pac::common::Reg<SmwDin, crate::pac::common::RW> {
        assert!(n < 4usize);
        unsafe {
            crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0164usize + n * 4usize) as _)
        }
    }
    ...
    #[doc = "SoC Trim Register."]
    #[inline(always)]
    pub const fn soctrim(
        self,
        n: usize,
    ) -> crate::pac::common::Reg<Soctrim, crate::pac::common::RW> {
        assert!(n < 32usize);
        unsafe {
    ...
    #[doc = "BIST Data Control Register."]
    #[inline(always)]
    pub const fn r_data_ctrl(
        self,
        n: usize,
    ) -> crate::pac::common::Reg<RDataCtrl, crate::pac::common::RW> {
        assert!(n < 3usize);
        unsafe {
            crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x026cusize + n * 4usize) as _)
        }
    }
    #[doc = "BIST Repair Register."]
    #[inline(always)]
    pub const fn r_repair(
        self,
        n: usize,
    ) -> crate::pac::common::Reg<RRepair, crate::pac::common::R> {
        assert!(n < 4usize);
        unsafe {
    ...
    #[doc = "BIST Data Control Extension Register."]
    #[inline(always)]
    pub const fn r_data_ctrl_ex(
        self,
        n: usize,
    ) -> crate::pac::common::Reg<RDataCtrlEx, crate::pac::common::RW> {
        assert!(n < 3usize);
        unsafe {
            crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x036cusize + n * 4usize) as _)
        }
    }
    ...
    #[doc = "FMU Repair Register."]
    #[inline(always)]
    pub const fn repair(self, n: usize) -> crate::pac::common::Reg<Repair, crate::pac::common::RW> {
        assert!(n < 4usize);
        unsafe {
...
impl defmt::Format for RDataCtrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "RDataCtrl {{ data: {=u32:?} }}", self.data())
    }
}
#[doc = "BIST Data Control 0 Register."]
#[repr(transparent)]
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct RDataCtrlEx(pub u32);
impl RDataCtrlEx {
    #[doc = "BIST Data High."]
    #[must_use]
    #[inline(always)]
    pub const fn datax(&self) -> u8 {
        let val = (self.0 >> 0usize) & 0x07;
        val as u8
    }
    #[doc = "BIST Data High."]
    #[inline(always)]
    pub const fn set_datax(&mut self, val: u8) {
        self.0 = (self.0 & !(0x07 << 0usize)) | (((val as u32) & 0x07) << 0usize);
    }
}
impl Default for RDataCtrlEx {
    #[inline(always)]
    fn default() -> RDataCtrlEx {
        RDataCtrlEx(0)
    }
}
impl core::fmt::Debug for RDataCtrlEx {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RDataCtrlEx")
            .field("datax", &self.datax())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for RDataCtrlEx {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "RDataCtrlEx {{ datax: {=u8:?} }}", self.datax())
    }
}
#[doc = "BIST DFT Control Register."]
#[repr(transparent)]
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct RRepair(pub u32);
impl RRepair {
    #[doc = "Control Repair Enable."]
    #[must_use]
    #[inline(always)]
    pub const fn rdis(&self) -> RRepairRdis {
        let val = (self.0 >> 0usize) & 0x01;
        RRepairRdis::from_bits(val as u8)
    }
    #[doc = "Control Repair Enable."]
    #[inline(always)]
    pub const fn set_rdis(&mut self, val: RRepairRdis) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "XADR for Repair."]
    #[must_use]
    #[inline(always)]
    pub const fn radr(&self) -> u8 {
        let val = (self.0 >> 1usize) & 0xff;
        val as u8
    }
    #[doc = "XADR for Repair."]
    #[inline(always)]
    pub const fn set_radr(&mut self, val: u8) {
        self.0 = (self.0 & !(0xff << 1usize)) | (((val as u32) & 0xff) << 1usize);
    }
}
impl Default for RRepair {
    #[inline(always)]
    fn default() -> RRepair {
        RRepair(0)
    }
}
impl core::fmt::Debug for RRepair {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RRepair")
            .field("rdis", &self.rdis())
            .field("radr", &self.radr())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for RRepair {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "RRepair {{ rdis: {:?}, radr: {=u8:?} }}",
            self.rdis(),
            self.radr()
        )
    }
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct RdData(pub u32);
impl RdData {
    #[doc = "Read Data."]
    #[must_use]
    #[inline(always)]
    pub const fn rd_data(&self) -> u32 {
        let val = (self.0 >> 0usize) & 0xffff_ffff;
        val as u32
    }
    #[doc = "Read Data."]
    #[inline(always)]
    pub const fn set_rd_data(&mut self, val: u32) {
        self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
    }
}
impl Default for RdData {
    #[inline(always)]
    fn default() -> RdData {
        RdData(0)
    }
}
impl core::fmt::Debug for RdData {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RdData")
            .field("rd_data", &self.rd_data())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for RdData {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "RdData {{ rd_data: {=u32:?} }}", self.rd_data())
    }
}
#[doc = "Read Path Control and Status Register."]
#[repr(transparent)]
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Repair(pub u32);
impl Repair {
    #[doc = "RDIS."]
    #[must_use]
    #[inline(always)]
    pub const fn rdis(&self) -> RepairRdis {
        let val = (self.0 >> 0usize) & 0x01;
        RepairRdis::from_bits(val as u8)
    }
    #[doc = "RDIS."]
    #[inline(always)]
    pub const fn set_rdis(&mut self, val: RepairRdis) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "RADR."]
    #[must_use]
...
impl core::fmt::Debug for Repair {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct SmwDin(pub u32);
impl SmwDin {
    #[doc = "SMW DIN."]
    #[must_use]
    #[inline(always)]
    pub const fn smw_din(&self) -> u32 {
        let val = (self.0 >> 0usize) & 0xffff_ffff;
        val as u32
    }
    #[doc = "SMW DIN."]
    #[inline(always)]
    pub const fn set_smw_din(&mut self, val: u32) {
        self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
    }
}
impl Default for SmwDin {
    #[inline(always)]
    fn default() -> SmwDin {
        SmwDin(0)
    }
}
impl core::fmt::Debug for SmwDin {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SmwDin")
            .field("smw_din", &self.smw_din())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for SmwDin {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "SmwDin {{ smw_din: {=u32:?} }}", self.smw_din())
    }
}
#[doc = "SMW HB Signals Register."]
#[repr(transparent)]
...
impl Soctrim {
    ...
    #[doc = "Trim value."]
    #[inline(always)]
    pub const fn set_trim(&mut self, val: u32) {
        self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
    }
}
impl Default for Soctrim {
    #[inline(always)]
    fn default() -> Soctrim {
        Soctrim(0)
    }
}
impl core::fmt::Debug for Soctrim {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Soctrim")
            .field("trim", &self.trim())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Soctrim {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Soctrim {{ trim: {=u32:?} }}", self.trim())
    }
}
#[doc = "User Interface Control Register."]
#[repr(transparent)]
...
impl RRepairRdis {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> RRepairRdis {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for RRepairRdis {
    #[inline(always)]
    fn from(val: u8) -> RRepairRdis {
        RRepairRdis::from_bits(val)
    }
}
impl From<RRepairRdis> for u8 {
    #[inline(always)]
    fn from(val: RRepairRdis) -> u8 {
        RRepairRdis::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl RepairRdis {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> RepairRdis {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for RepairRdis {
    #[inline(always)]
    fn from(val: u8) -> RepairRdis {
        RepairRdis::from_bits(val)
    }
}
impl From<RepairRdis> for u8 {
    #[inline(always)]
    fn from(val: RepairRdis) -> u8 {
        RepairRdis::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
