...
impl Syscon {
    ...
    #[doc = "ROM Wait State."]
    #[inline(always)]
    pub const fn romcr(self) -> crate::common::Reg<u32, crate::common::R> {
    ...
    #[doc = "OVP_PAD_STATE."]
    #[inline(always)]
    pub const fn ovp_pad_state(self) -> crate::common::Reg<regs::OvpPadState, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0e40usize) as _) }
    }
    #[doc = "PROBE_STATE."]
    #[inline(always)]
    pub const fn probe_state(self) -> crate::common::Reg<regs::ProbeState, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0e44usize) as _) }
    }
    #[doc = "FT_STATE_A."]
    #[inline(always)]
    pub const fn ft_state_a(self) -> crate::common::Reg<regs::FtStateA, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0e48usize) as _) }
    }
    #[doc = "FT_STATE_B."]
    #[inline(always)]
    pub const fn ft_state_b(self) -> crate::common::Reg<regs::FtStateB, crate::common::R> {
