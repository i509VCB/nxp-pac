...
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum DCFG_CC_SOCU_PIN_FA_ME_CMD_EN {
    #[doc = "Use DAP to enable."]
    ENABLE = 0x0,
    #[doc = "Fixed state."]
    DISABLE = 0x01,
}
impl DCFG_CC_SOCU_PIN_FA_ME_CMD_EN {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> DCFG_CC_SOCU_PIN_FA_ME_CMD_EN {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for DCFG_CC_SOCU_PIN_FA_ME_CMD_EN {
    #[inline(always)]
    fn from(val: u8) -> DCFG_CC_SOCU_PIN_FA_ME_CMD_EN {
        DCFG_CC_SOCU_PIN_FA_ME_CMD_EN::from_bits(val)
    }
}
impl From<DCFG_CC_SOCU_PIN_FA_ME_CMD_EN> for u8 {
    #[inline(always)]
    fn from(val: DCFG_CC_SOCU_PIN_FA_ME_CMD_EN) -> u8 {
        DCFG_CC_SOCU_PIN_FA_ME_CMD_EN::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
