...
pub struct CODE_BIN_LSB(pub u32);
impl CODE_BIN_LSB {
...
impl Default for CODE_BIN_LSB {
    #[inline(always)]
    fn default() -> CODE_BIN_LSB {
        CODE_BIN_LSB(0)
    }
}
impl core::fmt::Debug for CODE_BIN_LSB {
...
#[cfg(feature = "defmt")]
impl defmt::Format for CODE_BIN_LSB {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CODE_BIN_LSB {{ CODE_BIN_LSB: {=u32:?} }}",
            self.CODE_BIN_LSB()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct CODE_BIN_MSB(pub u32);
impl CODE_BIN_MSB {
    #[doc = "Binary converted code (42bits)."]
    #[must_use]
    #[inline(always)]
...
impl Default for CODE_BIN_MSB {
    #[inline(always)]
    fn default() -> CODE_BIN_MSB {
        CODE_BIN_MSB(0)
    }
}
impl core::fmt::Debug for CODE_BIN_MSB {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[cfg(feature = "defmt")]
impl defmt::Format for CODE_BIN_MSB {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CODE_BIN_MSB {{ CODE_BIN_MSB: {=u16:?} }}",
            self.CODE_BIN_MSB()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct CODE_GRAY_LSB(pub u32);
impl CODE_GRAY_LSB {
...
impl Default for CODE_GRAY_LSB {
    #[inline(always)]
    fn default() -> CODE_GRAY_LSB {
        CODE_GRAY_LSB(0)
    }
}
impl core::fmt::Debug for CODE_GRAY_LSB {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[cfg(feature = "defmt")]
impl defmt::Format for CODE_GRAY_LSB {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CODE_GRAY_LSB {{ CODE_GRAY_LSB: {=u32:?} }}",
            self.CODE_GRAY_LSB()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct CODE_GRAY_MSB(pub u32);
impl CODE_GRAY_MSB {
    #[doc = "Gray code (42bits) to be converted back to binary."]
    #[must_use]
    #[inline(always)]
...
impl Default for CODE_GRAY_MSB {
    #[inline(always)]
    fn default() -> CODE_GRAY_MSB {
        CODE_GRAY_MSB(0)
    }
}
impl core::fmt::Debug for CODE_GRAY_MSB {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[cfg(feature = "defmt")]
impl defmt::Format for CODE_GRAY_MSB {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CODE_GRAY_MSB {{ CODE_GRAY_MSB: {=u16:?} }}",
            self.CODE_GRAY_MSB()
        )
    }
}
