...
impl CPU0_LOCK_REG {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn LOCK_NS_VTOR(&self) -> super::vals::LOCK_NS_VTOR {
        let val = (self.0 >> 0usize) & 0x03;
        super::vals::LOCK_NS_VTOR::from_bits(val as u8)
    }
    #[doc = "Cortex M33 (CPU0) VTOR_NS register write-lock."]
    #[inline(always)]
    pub const fn set_LOCK_NS_VTOR(&mut self, val: super::vals::LOCK_NS_VTOR) {
        self.0 = (self.0 & !(0x03 << 0usize)) | (((val.to_bits() as u32) & 0x03) << 0usize);
    }
    #[doc = "Cortex M33 (CPU0) non-secure MPU register write-lock."]
    #[must_use]
    #[inline(always)]
    pub const fn LOCK_NS_MPU(&self) -> super::vals::LOCK_NS_MPU {
        let val = (self.0 >> 2usize) & 0x03;
        super::vals::LOCK_NS_MPU::from_bits(val as u8)
    }
    #[doc = "Cortex M33 (CPU0) non-secure MPU register write-lock."]
    #[inline(always)]
    pub const fn set_LOCK_NS_MPU(&mut self, val: super::vals::LOCK_NS_MPU) {
...
impl MASTER_SEC_ANTI_POL_REG {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn CANFD(&self) -> super::vals::MASTER_SEC_ANTI_POL_REG_CANFD {
        let val = (self.0 >> 26usize) & 0x03;
        super::vals::MASTER_SEC_ANTI_POL_REG_CANFD::from_bits(val as u8)
    }
    #[doc = "CAN FD. Must be equal to NOT(MASTER_SEC_LEVEL.CANFD)."]
    #[inline(always)]
    pub const fn set_CANFD(&mut self, val: super::vals::MASTER_SEC_ANTI_POL_REG_CANFD) {
...
impl defmt::Format for MASTER_SEC_ANTI_POL_REG {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "MASTER_SEC_ANTI_POL_REG {{ USBFSD: {:?}, SDMA0: {:?}, HASH: {:?}, USBFSH: {:?}, SDMA1: {:?}, CANFD: {:?}, MASTER_SEC_LEVEL_ANTIPOL_LOCK: {:?} }}",
            self.USBFSD(),
            self.SDMA0(),
            self.HASH(),
            self.USBFSH(),
...
impl MASTER_SEC_LEVEL {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn CANFD(&self) -> super::vals::MASTER_SEC_LEVEL_CANFD {
        let val = (self.0 >> 26usize) & 0x03;
        super::vals::MASTER_SEC_LEVEL_CANFD::from_bits(val as u8)
    }
    #[doc = "CAN FD."]
    #[inline(always)]
    pub const fn set_CANFD(&mut self, val: super::vals::MASTER_SEC_LEVEL_CANFD) {
        self.0 = (self.0 & !(0x03 << 26usize)) | (((val.to_bits() as u32) & 0x03) << 26usize);
    }
...
impl defmt::Format for MASTER_SEC_LEVEL {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "MASTER_SEC_LEVEL {{ USBFSD: {:?}, SDMA0: {:?}, HASH: {:?}, USBFSH: {:?}, SDMA1: {:?}, CANFD: {:?}, MASTER_SEC_LEVEL_LOCK: {:?} }}",
            self.USBFSD(),
            self.SDMA0(),
            self.HASH(),
            self.USBFSH(),
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct SEC_CTRL_AHB_PORT7_SLAVE0_RULE(pub u32);
impl SEC_CTRL_AHB_PORT7_SLAVE0_RULE {
    #[doc = "DMA Controller."]
    #[must_use]
    #[inline(always)]
...
impl Default for SEC_CTRL_AHB_PORT7_SLAVE0_RULE {
    #[inline(always)]
    fn default() -> SEC_CTRL_AHB_PORT7_SLAVE0_RULE {
        SEC_CTRL_AHB_PORT7_SLAVE0_RULE(0)
    }
}
impl core::fmt::Debug for SEC_CTRL_AHB_PORT7_SLAVE0_RULE {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[cfg(feature = "defmt")]
impl defmt::Format for SEC_CTRL_AHB_PORT7_SLAVE0_RULE {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_CTRL_AHB_PORT7_SLAVE0_RULE {{ DMA0_RULE: {:?}, FS_USB_DEV_RULE: {:?}, SCT_RULE: {:?}, FLEXCOMM0_RULE: {:?}, FLEXCOMM1_RULE: {:?} }}",
            self.DMA0_RULE(),
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct SEC_CTRL_AHB_PORT7_SLAVE1_RULE(pub u32);
impl SEC_CTRL_AHB_PORT7_SLAVE1_RULE {
...
impl Default for SEC_CTRL_AHB_PORT7_SLAVE1_RULE {
    #[inline(always)]
    fn default() -> SEC_CTRL_AHB_PORT7_SLAVE1_RULE {
        SEC_CTRL_AHB_PORT7_SLAVE1_RULE(0)
    }
}
impl core::fmt::Debug for SEC_CTRL_AHB_PORT7_SLAVE1_RULE {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[cfg(feature = "defmt")]
impl defmt::Format for SEC_CTRL_AHB_PORT7_SLAVE1_RULE {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_CTRL_AHB_PORT7_SLAVE1_RULE {{ FLEXCOMM2_RULE: {:?}, FLEXCOMM3_RULE: {:?}, FLEXCOMM4_RULE: {:?}, GPIO0_RULE: {:?} }}",
            self.FLEXCOMM2_RULE(),
            self.FLEXCOMM3_RULE(),
            self.FLEXCOMM4_RULE(),
            self.GPIO0_RULE()
...
impl defmt::Format for SEC_CTRL_AHB_PORT8_SLAVE0_RULE {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_CTRL_AHB_PORT8_SLAVE0_RULE {{ USB_HS_DEV_RULE: {:?}, CRC_RULE: {:?}, FLEXCOMM5_RULE: {:?}, FLEXCOMM6_RULE: {:?} }}",
...
impl SEC_CTRL_AHB_PORT8_SLAVE1_RULE {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn CAN0_RULE(&self) -> super::vals::CAN0_RULE {
        let val = (self.0 >> 20usize) & 0x03;
        super::vals::CAN0_RULE::from_bits(val as u8)
    }
    #[doc = "CAN-FD."]
    #[inline(always)]
    pub const fn set_CAN0_RULE(&mut self, val: super::vals::CAN0_RULE) {
        self.0 = (self.0 & !(0x03 << 20usize)) | (((val.to_bits() as u32) & 0x03) << 20usize);
    }
    #[doc = "High Speed SPI."]
    #[must_use]
...
impl defmt::Format for SEC_CTRL_AHB_PORT8_SLAVE1_RULE {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_CTRL_AHB_PORT8_SLAVE1_RULE {{ FLEXCOMM7_RULE: {:?}, DBG_MAILBOX_RULE: {:?}, CAN0_RULE: {:?}, HS_LSPI_RULE: {:?} }}",
            self.FLEXCOMM7_RULE(),
...
impl defmt::Format for SEC_CTRL_AHB_PORT9_SLAVE0_RULE {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_CTRL_AHB_PORT9_SLAVE0_RULE {{ ADC_RULE: {:?}, USB_FS_HOST_RULE: {:?}, USB_HS_HOST_RULE: {:?}, HASH_RULE: {:?}, CASPER_RULE: {:?}, DMA1_RULE: {:?} }}",
            self.ADC_RULE(),
...
impl defmt::Format for SEC_CTRL_AHB_PORT9_SLAVE1_RULE {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_CTRL_AHB_PORT9_SLAVE1_RULE {{ GPIO1_RULE: {:?}, AHB_SEC_CTRL_RULE: {:?} }}",
            self.GPIO1_RULE(),
...
impl SEC_CTRL_APB_BRIDGE1_MEM_CTRL0 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn SPI_FILTER_RULE(&self) -> super::vals::SPI_FILTER_RULE {
        let val = (self.0 >> 16usize) & 0x03;
        super::vals::SPI_FILTER_RULE::from_bits(val as u8)
    }
    #[doc = "SPI FILTER control."]
    #[inline(always)]
    pub const fn set_SPI_FILTER_RULE(&mut self, val: super::vals::SPI_FILTER_RULE) {
        self.0 = (self.0 & !(0x03 << 16usize)) | (((val.to_bits() as u32) & 0x03) << 16usize);
    }
}
...
impl defmt::Format for SEC_CTRL_APB_BRIDGE1_MEM_CTRL0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_CTRL_APB_BRIDGE1_MEM_CTRL0 {{ PMC_RULE: {:?}, SYSCTRL_RULE: {:?}, SPI_FILTER_RULE: {:?} }}",
            self.PMC_RULE(),
            self.SYSCTRL_RULE(),
...
impl defmt::Format for SEC_CTRL_RAM1_MEM_RULE0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_CTRL_RAM1_MEM_RULE0 {{ RULE0: {:?}, RULE1: {:?}, RULE2: {:?}, RULE3: {:?} }}",
            self.RULE0(),
            self.RULE1(),
            self.RULE2(),
            self.RULE3()
...
impl defmt::Format for SEC_CTRL_RAM2_MEM_RULE0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_CTRL_RAM2_MEM_RULE0 {{ RULE0: {:?}, RULE1: {:?}, RULE2: {:?}, RULE3: {:?} }}",
            self.RULE0(),
            self.RULE1(),
            self.RULE2(),
            self.RULE3()
...
impl defmt::Format for SEC_CTRL_RAMX_MEM_RULE0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_CTRL_RAMX_MEM_RULE0 {{ RULE0: {:?}, RULE1: {:?}, RULE2: {:?}, RULE3: {:?} }}",
            self.RULE0(),
            self.RULE1(),
            self.RULE2(),
            self.RULE3()
...
impl defmt::Format for SEC_MASK_LOCK {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_MASK_LOCK {{ SEC_GPIO_MASK0_LOCK: {:?}, SEC_GPIO_MASK1_LOCK: {:?} }}",
...
impl defmt::Format for SEC_VIO_INFO_VALID {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SEC_VIO_INFO_VALID {{ VIO_INFO_VALID0: {=bool:?}, VIO_INFO_VALID1: {=bool:?}, VIO_INFO_VALID2: {=bool:?}, VIO_INFO_VALID3: {=bool:?}, VIO_INFO_VALID4: {=bool:?}, VIO_INFO_VALID5: {=bool:?}, VIO_INFO_VALID6: {=bool:?}, VIO_INFO_VALID7: {=bool:?}, VIO_INFO_VALID8: {=bool:?}, VIO_INFO_VALID9: {=bool:?} }}",
