...
impl CAN0_RULE {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> CAN0_RULE {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for CAN0_RULE {
    #[inline(always)]
    fn from(val: u8) -> CAN0_RULE {
        CAN0_RULE::from_bits(val)
    }
}
impl From<CAN0_RULE> for u8 {
    #[inline(always)]
    fn from(val: CAN0_RULE) -> u8 {
        CAN0_RULE::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl LOCK_NS_MPU {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> LOCK_NS_MPU {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for LOCK_NS_MPU {
    #[inline(always)]
    fn from(val: u8) -> LOCK_NS_MPU {
        LOCK_NS_MPU::from_bits(val)
    }
}
impl From<LOCK_NS_MPU> for u8 {
    #[inline(always)]
    fn from(val: LOCK_NS_MPU) -> u8 {
        LOCK_NS_MPU::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum LOCK_NS_VTOR {
    _RESERVED_0 = 0x0,
    #[doc = "Restricted mode."]
    BLOCKED = 0x01,
    #[doc = "Writable."]
...
impl LOCK_NS_VTOR {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> LOCK_NS_VTOR {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for LOCK_NS_VTOR {
    #[inline(always)]
    fn from(val: u8) -> LOCK_NS_VTOR {
        LOCK_NS_VTOR::from_bits(val)
    }
}
impl From<LOCK_NS_VTOR> for u8 {
    #[inline(always)]
    fn from(val: LOCK_NS_VTOR) -> u8 {
        LOCK_NS_VTOR::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum MASTER_SEC_ANTI_POL_REG_CANFD {
    #[doc = "Secure and Priviledge user access allowed."]
    ENUM_S_P = 0x0,
    #[doc = "Secure and Non-priviledge user access allowed."]
    ENUM_S_NP = 0x01,
...
impl MASTER_SEC_ANTI_POL_REG_CANFD {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> MASTER_SEC_ANTI_POL_REG_CANFD {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for MASTER_SEC_ANTI_POL_REG_CANFD {
    #[inline(always)]
    fn from(val: u8) -> MASTER_SEC_ANTI_POL_REG_CANFD {
        MASTER_SEC_ANTI_POL_REG_CANFD::from_bits(val)
    }
}
impl From<MASTER_SEC_ANTI_POL_REG_CANFD> for u8 {
    #[inline(always)]
    fn from(val: MASTER_SEC_ANTI_POL_REG_CANFD) -> u8 {
        MASTER_SEC_ANTI_POL_REG_CANFD::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum MASTER_SEC_LEVEL_CANFD {
    #[doc = "Non-secure and Non-priviledge user access allowed."]
    ENUM_NS_NP = 0x0,
    #[doc = "Non-secure and Privilege access allowed."]
    ENUM_NS_P = 0x01,
...
impl MASTER_SEC_LEVEL_CANFD {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> MASTER_SEC_LEVEL_CANFD {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for MASTER_SEC_LEVEL_CANFD {
    #[inline(always)]
    fn from(val: u8) -> MASTER_SEC_LEVEL_CANFD {
        MASTER_SEC_LEVEL_CANFD::from_bits(val)
    }
}
impl From<MASTER_SEC_LEVEL_CANFD> for u8 {
    #[inline(always)]
    fn from(val: MASTER_SEC_LEVEL_CANFD) -> u8 {
        MASTER_SEC_LEVEL_CANFD::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl SPI_FILTER_RULE {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SPI_FILTER_RULE {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SPI_FILTER_RULE {
    #[inline(always)]
    fn from(val: u8) -> SPI_FILTER_RULE {
        SPI_FILTER_RULE::from_bits(val)
    }
}
impl From<SPI_FILTER_RULE> for u8 {
    #[inline(always)]
    fn from(val: SPI_FILTER_RULE) -> u8 {
        SPI_FILTER_RULE::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
