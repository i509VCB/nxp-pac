...
pub enum BODCORERESETENA_SECURE {
    _RESERVED_0 = 0x0,
...
impl BODCORERESETENA_SECURE {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> BODCORERESETENA_SECURE {
...
impl From<u8> for BODCORERESETENA_SECURE {
    #[inline(always)]
    fn from(val: u8) -> BODCORERESETENA_SECURE {
        BODCORERESETENA_SECURE::from_bits(val)
    }
}
impl From<BODCORERESETENA_SECURE> for u8 {
    #[inline(always)]
    fn from(val: BODCORERESETENA_SECURE) -> u8 {
        BODCORERESETENA_SECURE::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum BODCORERESETENA_SECURE_DP {
    _RESERVED_0 = 0x0,
    #[doc = "Any other value than b10, BOD Core reset is enable."]
    ENABLE = 0x01,
    #[doc = "BOD Core reset is disable."]
...
impl BODCORERESETENA_SECURE_DP {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> BODCORERESETENA_SECURE_DP {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for BODCORERESETENA_SECURE_DP {
    #[inline(always)]
    fn from(val: u8) -> BODCORERESETENA_SECURE_DP {
        BODCORERESETENA_SECURE_DP::from_bits(val)
    }
}
impl From<BODCORERESETENA_SECURE_DP> for u8 {
    #[inline(always)]
    fn from(val: BODCORERESETENA_SECURE_DP) -> u8 {
        BODCORERESETENA_SECURE_DP::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum BODVBATRESETENA_SECURE {
    _RESERVED_0 = 0x0,
...
impl BODVBATRESETENA_SECURE {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> BODVBATRESETENA_SECURE {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for BODVBATRESETENA_SECURE {
    #[inline(always)]
    fn from(val: u8) -> BODVBATRESETENA_SECURE {
        BODVBATRESETENA_SECURE::from_bits(val)
    }
}
impl From<BODVBATRESETENA_SECURE> for u8 {
    #[inline(always)]
    fn from(val: BODVBATRESETENA_SECURE) -> u8 {
        BODVBATRESETENA_SECURE::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum BODVBATRESETENA_SECURE_DP {
    _RESERVED_0 = 0x0,
    #[doc = "Any other value than b10, BOD VBAT reset is enable."]
    ENABLE = 0x01,
    #[doc = "BOD VBAT reset is disable."]
...
impl BODVBATRESETENA_SECURE_DP {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> BODVBATRESETENA_SECURE_DP {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for BODVBATRESETENA_SECURE_DP {
    #[inline(always)]
    fn from(val: u8) -> BODVBATRESETENA_SECURE_DP {
        BODVBATRESETENA_SECURE_DP::from_bits(val)
    }
}
impl From<BODVBATRESETENA_SECURE_DP> for u8 {
    #[inline(always)]
    fn from(val: BODVBATRESETENA_SECURE_DP) -> u8 {
        BODVBATRESETENA_SECURE_DP::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl WAKEUPIO_RSTN {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> WAKEUPIO_RSTN {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for WAKEUPIO_RSTN {
    #[inline(always)]
    fn from(val: u8) -> WAKEUPIO_RSTN {
        WAKEUPIO_RSTN::from_bits(val)
    }
}
impl From<WAKEUPIO_RSTN> for u8 {
    #[inline(always)]
    fn from(val: WAKEUPIO_RSTN) -> u8 {
        WAKEUPIO_RSTN::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
