...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct DUMMY_CTRL(pub u32);
impl DUMMY_CTRL {
    #[doc = "Control High speed Crystal oscillator mode of the ADC clock."]
    #[must_use]
    #[inline(always)]
    pub const fn XO32M_ADC_CLK_MODE(&self) -> super::vals::XO32M_ADC_CLK_MODE {
        let val = (self.0 >> 10usize) & 0x03;
        super::vals::XO32M_ADC_CLK_MODE::from_bits(val as u8)
    }
    #[doc = "Control High speed Crystal oscillator mode of the ADC clock."]
    #[inline(always)]
    pub const fn set_XO32M_ADC_CLK_MODE(&mut self, val: super::vals::XO32M_ADC_CLK_MODE) {
        self.0 = (self.0 & !(0x03 << 10usize)) | (((val.to_bits() as u32) & 0x03) << 10usize);
    }
}
impl Default for DUMMY_CTRL {
    #[inline(always)]
    fn default() -> DUMMY_CTRL {
        DUMMY_CTRL(0)
    }
}
impl core::fmt::Debug for DUMMY_CTRL {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[cfg(feature = "defmt")]
impl defmt::Format for DUMMY_CTRL {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "DUMMY_CTRL {{ XO32M_ADC_CLK_MODE: {:?} }}",
...
impl defmt::Format for FRO192M_CTRL {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "FRO192M_CTRL {{ ENA_12MHZCLK: {=bool:?}, DAC_TRIM: {=u8:?}, USBCLKADJ: {=bool:?}, USBMODCHG: {=bool:?}, ENA_96MHZCLK: {=bool:?}, WRTRIM: {=bool:?} }}",
            self.ENA_12MHZCLK(),
            self.DAC_TRIM(),
            self.USBCLKADJ(),
            self.USBMODCHG(),
...
impl defmt::Format for USBHS_PHY_CTRL {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "USBHS_PHY_CTRL {{ usb_vbusvalid_ext: {=bool:?}, usb_id_ext: {=bool:?}, iso_atx: {=bool:?} }}",
