...
impl PUF {
    ...
    #[doc = "no description available."]
    #[inline(always)]
    pub const fn IDXBLK_DP(self) -> crate::common::Reg<regs::IDXBLK_DP, crate::common::W> {
    ...
    #[inline(always)]
    pub const fn IDXBLK_STATUS(self) -> crate::common::Reg<regs::IDXBLK_STATUS, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0254usize) as _) }
    }
    #[doc = "no description available."]
    #[inline(always)]
    pub const fn SHIFT_STATUS(self) -> crate::common::Reg<regs::SHIFT_STATUS, crate::common::R> {
