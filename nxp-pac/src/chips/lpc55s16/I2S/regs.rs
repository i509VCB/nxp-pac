...
impl CFG1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ONECHANNEL(&self) -> super::vals::CFG1_ONECHANNEL {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::CFG1_ONECHANNEL::from_bits(val as u8)
    }
    #[doc = "Single channel mode. Applies to both transmit and receive. This configuration bit applies only to the first I2S channel pair. Other channel pairs may select this mode independently in their separate CFG1 registers."]
    #[inline(always)]
    pub const fn set_ONECHANNEL(&mut self, val: super::vals::CFG1_ONECHANNEL) {
...
impl PCFG1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ONECHANNEL(&self) -> super::vals::PCFG1_ONECHANNEL {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PCFG1_ONECHANNEL::from_bits(val as u8)
    }
    #[doc = "Single channel mode."]
    #[inline(always)]
    pub const fn set_ONECHANNEL(&mut self, val: super::vals::PCFG1_ONECHANNEL) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl PSTAT {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn BUSY(&self) -> super::vals::PSTAT_BUSY {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::PSTAT_BUSY::from_bits(val as u8)
    }
    #[doc = "Busy status for this channel pair."]
    #[inline(always)]
    pub const fn set_BUSY(&mut self, val: super::vals::PSTAT_BUSY) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn DATAPAUSED(&self) -> super::vals::PSTAT_DATAPAUSED {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::PSTAT_DATAPAUSED::from_bits(val as u8)
    }
    #[doc = "Data Paused status flag."]
    #[inline(always)]
    pub const fn set_DATAPAUSED(&mut self, val: super::vals::PSTAT_DATAPAUSED) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
}
...
impl STAT {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn BUSY(&self) -> super::vals::STAT_BUSY {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::STAT_BUSY::from_bits(val as u8)
    }
    #[doc = "Busy status for the primary channel pair. Other BUSY flags may be found in the STAT register for each channel pair."]
    #[inline(always)]
    pub const fn set_BUSY(&mut self, val: super::vals::STAT_BUSY) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
