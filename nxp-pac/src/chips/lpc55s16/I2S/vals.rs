...
impl CFG1_ONECHANNEL {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> CFG1_ONECHANNEL {
...
impl From<u8> for CFG1_ONECHANNEL {
    #[inline(always)]
    fn from(val: u8) -> CFG1_ONECHANNEL {
        CFG1_ONECHANNEL::from_bits(val)
    }
}
impl From<CFG1_ONECHANNEL> for u8 {
    #[inline(always)]
    fn from(val: CFG1_ONECHANNEL) -> u8 {
        CFG1_ONECHANNEL::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl From<u8> for PCFG1_ONECHANNEL {
    #[inline(always)]
    fn from(val: u8) -> PCFG1_ONECHANNEL {
        PCFG1_ONECHANNEL::from_bits(val)
    }
}
impl From<PCFG1_ONECHANNEL> for u8 {
    #[inline(always)]
    fn from(val: PCFG1_ONECHANNEL) -> u8 {
        PCFG1_ONECHANNEL::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl PSTAT_BUSY {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PSTAT_BUSY {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PSTAT_BUSY {
    #[inline(always)]
    fn from(val: u8) -> PSTAT_BUSY {
        PSTAT_BUSY::from_bits(val)
    }
}
impl From<PSTAT_BUSY> for u8 {
    #[inline(always)]
    fn from(val: PSTAT_BUSY) -> u8 {
        PSTAT_BUSY::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum PSTAT_DATAPAUSED {
    #[doc = "Data is not currently paused."]
    PAUSE = 0x0,
    #[doc = "A data pause has been requested and is now in force."]
    FORCE = 0x01,
}
impl PSTAT_DATAPAUSED {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PSTAT_DATAPAUSED {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PSTAT_DATAPAUSED {
    #[inline(always)]
    fn from(val: u8) -> PSTAT_DATAPAUSED {
        PSTAT_DATAPAUSED::from_bits(val)
    }
}
impl From<PSTAT_DATAPAUSED> for u8 {
    #[inline(always)]
    fn from(val: PSTAT_DATAPAUSED) -> u8 {
        PSTAT_DATAPAUSED::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl STAT_BUSY {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> STAT_BUSY {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for STAT_BUSY {
    #[inline(always)]
    fn from(val: u8) -> STAT_BUSY {
        STAT_BUSY::from_bits(val)
    }
}
impl From<STAT_BUSY> for u8 {
    #[inline(always)]
    fn from(val: STAT_BUSY) -> u8 {
        STAT_BUSY::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
