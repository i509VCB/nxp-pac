...
pub const FLASH_CFPA_SCRATCH: FLASH_CFPA::FLASH_CFPA =
    unsafe { FLASH_CFPA::FLASH_CFPA::from_ptr(0x0009_de00usize as _) };
#[doc = "FLASH_CFPA"]
pub const FLASH_CFPA0: FLASH_CFPA::FLASH_CFPA =
    unsafe { FLASH_CFPA::FLASH_CFPA::from_ptr(0x0009_e000usize as _) };
#[doc = "FLASH_CFPA"]
pub const FLASH_CFPA1: FLASH_CFPA::FLASH_CFPA =
    unsafe { FLASH_CFPA::FLASH_CFPA::from_ptr(0x0009_e200usize as _) };
#[doc = "FLASH_CMPA"]
pub const FLASH_CMPA: FLASH_CMPA::FLASH_CMPA =
    unsafe { FLASH_CMPA::FLASH_CMPA::from_ptr(0x0009_e400usize as _) };
#[doc = "FLASH_KEY_STORE"]
pub const FLASH_KEY_STORE: FLASH_KEY_STORE::FLASH_KEY_STORE =
    unsafe { FLASH_KEY_STORE::FLASH_KEY_STORE::from_ptr(0x0009_e600usize as _) };
#[doc = "SYSCON"]
