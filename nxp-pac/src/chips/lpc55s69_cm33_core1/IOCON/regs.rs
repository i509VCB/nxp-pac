...
impl PIO0_0 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO0_0_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO0_0_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO0_0_ASW) {
...
impl defmt::Format for PIO0_0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO0_0 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO0_10 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO0_10_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO0_10_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO0_10_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO0_10 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO0_10 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO0_11 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO0_11_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO0_11_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO0_11_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO0_11 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO0_11 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO0_12 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO0_12_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO0_12_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO0_12_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO0_12 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO0_12 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO0_15 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO0_15_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO0_15_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO0_15_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO0_15 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO0_15 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO0_16 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO0_16_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO0_16_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO0_16_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO0_16 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO0_16 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO0_18 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO0_18_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO0_18_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO0_18_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO0_18 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO0_18 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO0_23 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO0_23_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO0_23_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO0_23_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO0_23 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO0_23 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO0_31 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO0_31_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO0_31_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO0_31_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO0_31 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO0_31 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO0_9 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO0_9_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO0_9_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO0_9_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO0_9 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO0_9 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO1_0 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO1_0_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO1_0_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO1_0_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO1_0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO1_0 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO1_14 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO1_14_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO1_14_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO1_14_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO1_14 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO1_14 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO1_19 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO1_19_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO1_19_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO1_19_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO1_19 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO1_19 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO1_8 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO1_8_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO1_8_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO1_8_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO1_8 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO1_8 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
...
impl PIO1_9 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ASW(&self) -> super::vals::PIO1_9_ASW {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::PIO1_9_ASW::from_bits(val as u8)
    }
    #[doc = "Analog switch input control."]
    #[inline(always)]
    pub const fn set_ASW(&mut self, val: super::vals::PIO1_9_ASW) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl defmt::Format for PIO1_9 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PIO1_9 {{ FUNC: {:?}, MODE: {:?}, SLEW: {:?}, INVERT: {=bool:?}, DIGIMODE: {:?}, OD: {:?}, ASW: {:?} }}",
            self.FUNC(),
            self.MODE(),
            self.SLEW(),
            self.INVERT(),
