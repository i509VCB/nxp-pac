...
impl defmt::Format for USB1_VBUS_DETECT {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "USB1_VBUS_DETECT {{ VBUSVALID_THRESH: {:?}, VBUS_OVERRIDE_EN: {:?}, SESSEND_OVERRIDE: {=bool:?}, BVALID_OVERRIDE: {=bool:?}, AVALID_OVERRIDE: {=bool:?}, VBUSVALID_OVERRIDE: {=bool:?}, VBUSVALID_SEL: {:?}, VBUS_SOURCE_SEL: {:?}, ID_OVERRIDE_EN: {=bool:?}, ID_OVERRIDE: {=bool:?}, EXT_ID_OVERRIDE_EN: {:?}, EXT_VBUS_OVERRIDE_EN: {:?}, VBUSVALID_TO_SESSVALID: {:?}, VBUSVALID_5VDETECT: {=bool:?}, PWRUP_CMPS: {:?}, DISCHARGE_VBUS: {:?} }}",
...
impl defmt::Format for USB1_VBUS_DETECT_CLR {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "USB1_VBUS_DETECT_CLR {{ VBUSVALID_THRESH: {:?}, VBUS_OVERRIDE_EN: {:?}, SESSEND_OVERRIDE: {=bool:?}, BVALID_OVERRIDE: {=bool:?}, AVALID_OVERRIDE: {=bool:?}, VBUSVALID_OVERRIDE: {=bool:?}, VBUSVALID_SEL: {:?}, VBUS_SOURCE_SEL: {:?}, ID_OVERRIDE_EN: {=bool:?}, ID_OVERRIDE: {=bool:?}, EXT_ID_OVERRIDE_EN: {:?}, EXT_VBUS_OVERRIDE_EN: {:?}, VBUSVALID_TO_SESSVALID: {:?}, VBUSVALID_5VDETECT: {=bool:?}, PWRUP_CMPS: {:?}, DISCHARGE_VBUS: {:?} }}",
            self.VBUSVALID_THRESH(),
            self.VBUS_OVERRIDE_EN(),
            self.SESSEND_OVERRIDE(),
            self.BVALID_OVERRIDE(),
...
impl defmt::Format for USB1_VBUS_DETECT_SET {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "USB1_VBUS_DETECT_SET {{ VBUSVALID_THRESH: {:?}, VBUS_OVERRIDE_EN: {:?}, SESSEND_OVERRIDE: {=bool:?}, BVALID_OVERRIDE: {=bool:?}, AVALID_OVERRIDE: {=bool:?}, VBUSVALID_OVERRIDE: {=bool:?}, VBUSVALID_SEL: {:?}, VBUS_SOURCE_SEL: {:?}, ID_OVERRIDE_EN: {=bool:?}, ID_OVERRIDE: {=bool:?}, EXT_ID_OVERRIDE_EN: {:?}, EXT_VBUS_OVERRIDE_EN: {:?}, VBUSVALID_TO_SESSVALID: {:?}, VBUSVALID_5VDETECT: {=bool:?}, PWRUP_CMPS: {:?}, DISCHARGE_VBUS: {:?} }}",
            self.VBUSVALID_THRESH(),
            self.VBUS_OVERRIDE_EN(),
            self.SESSEND_OVERRIDE(),
            self.BVALID_OVERRIDE(),
...
impl defmt::Format for USB1_VBUS_DETECT_TOG {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "USB1_VBUS_DETECT_TOG {{ VBUSVALID_THRESH: {:?}, VBUS_OVERRIDE_EN: {:?}, SESSEND_OVERRIDE: {=bool:?}, BVALID_OVERRIDE: {=bool:?}, AVALID_OVERRIDE: {=bool:?}, VBUSVALID_OVERRIDE: {=bool:?}, VBUSVALID_SEL: {:?}, VBUS_SOURCE_SEL: {:?}, ID_OVERRIDE_EN: {=bool:?}, ID_OVERRIDE: {=bool:?}, EXT_ID_OVERRIDE_EN: {:?}, EXT_VBUS_OVERRIDE_EN: {:?}, VBUSVALID_TO_SESSVALID: {:?}, VBUSVALID_5VDETECT: {=bool:?}, PWRUP_CMPS: {:?}, DISCHARGE_VBUS: {:?} }}",
            self.VBUSVALID_THRESH(),
            self.VBUS_OVERRIDE_EN(),
            self.SESSEND_OVERRIDE(),
            self.BVALID_OVERRIDE(),
