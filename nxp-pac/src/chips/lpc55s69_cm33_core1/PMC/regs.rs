...
impl MISCCTRL {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn WAKUPIO_RST(&self) -> super::vals::WAKUPIO_RST {
        let val = (self.0 >> 15usize) & 0x01;
        super::vals::WAKUPIO_RST::from_bits(val as u8)
    }
    #[doc = "WAKEUP IO event detector reset control."]
    #[inline(always)]
    pub const fn set_WAKUPIO_RST(&mut self, val: super::vals::WAKUPIO_RST) {
