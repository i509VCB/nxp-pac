...
impl Default for IDXBLK_H {
    #[inline(always)]
    fn default() -> IDXBLK_H {
        IDXBLK_H(0)
    }
}
impl core::fmt::Debug for IDXBLK_H {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[cfg(feature = "defmt")]
impl defmt::Format for IDXBLK_H {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "IDXBLK_H {{ IDX8: {=u8:?}, IDX9: {=u8:?}, IDX10: {=u8:?}, IDX11: {=u8:?}, IDX12: {=u8:?}, IDX13: {=u8:?}, IDX14: {=u8:?}, IDX15: {=u8:?}, LOCK_IDX: {=u8:?} }}",
            self.IDX8(),
            self.IDX9(),
            self.IDX10(),
            self.IDX11(),
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct IDXBLK_H_DP(pub u32);
impl IDXBLK_H_DP {
    #[doc = "Use to block PUF index 8."]
    #[must_use]
    #[inline(always)]
...
impl Default for IDXBLK_H_DP {
    #[inline(always)]
    fn default() -> IDXBLK_H_DP {
        IDXBLK_H_DP(0)
    }
}
impl core::fmt::Debug for IDXBLK_H_DP {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[cfg(feature = "defmt")]
impl defmt::Format for IDXBLK_H_DP {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "IDXBLK_H_DP {{ IDX8: {=u8:?}, IDX9: {=u8:?}, IDX10: {=u8:?}, IDX11: {=u8:?}, IDX12: {=u8:?}, IDX13: {=u8:?}, IDX14: {=u8:?}, IDX15: {=u8:?} }}",
            self.IDX8(),
            self.IDX9(),
            self.IDX10(),
            self.IDX11(),
...
impl Default for IDXBLK_L {
    #[inline(always)]
    fn default() -> IDXBLK_L {
        IDXBLK_L(0)
    }
}
impl core::fmt::Debug for IDXBLK_L {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[cfg(feature = "defmt")]
impl defmt::Format for IDXBLK_L {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "IDXBLK_L {{ IDX1: {=u8:?}, IDX2: {=u8:?}, IDX3: {=u8:?}, IDX4: {=u8:?}, IDX5: {=u8:?}, IDX6: {=u8:?}, IDX7: {=u8:?}, LOCK_IDX: {=u8:?} }}",
            self.IDX1(),
            self.IDX2(),
            self.IDX3(),
            self.IDX4(),
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct IDXBLK_L_DP(pub u32);
impl IDXBLK_L_DP {
    #[doc = "Use to block PUF index 1."]
    #[must_use]
    #[inline(always)]
...
impl Default for IDXBLK_L_DP {
    #[inline(always)]
    fn default() -> IDXBLK_L_DP {
        IDXBLK_L_DP(0)
    }
}
impl core::fmt::Debug for IDXBLK_L_DP {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
#[cfg(feature = "defmt")]
impl defmt::Format for IDXBLK_L_DP {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "IDXBLK_L_DP {{ IDX1: {=u8:?}, IDX2: {=u8:?}, IDX3: {=u8:?}, IDX4: {=u8:?}, IDX5: {=u8:?}, IDX6: {=u8:?}, IDX7: {=u8:?} }}",
            self.IDX1(),
            self.IDX2(),
            self.IDX3(),
            self.IDX4(),
