...
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum CC_SOCU_PIN_CPU1_DBGEN {
    #[doc = "Use DAP to enable."]
    ENABLE = 0x0,
    #[doc = "Fixed state."]
    DISABLE = 0x01,
}
impl CC_SOCU_PIN_CPU1_DBGEN {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> CC_SOCU_PIN_CPU1_DBGEN {
...
impl From<u8> for CC_SOCU_PIN_CPU1_DBGEN {
    #[inline(always)]
    fn from(val: u8) -> CC_SOCU_PIN_CPU1_DBGEN {
        CC_SOCU_PIN_CPU1_DBGEN::from_bits(val)
    }
}
impl From<CC_SOCU_PIN_CPU1_DBGEN> for u8 {
    #[inline(always)]
    fn from(val: CC_SOCU_PIN_CPU1_DBGEN) -> u8 {
        CC_SOCU_PIN_CPU1_DBGEN::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum CC_SOCU_PIN_CPU1_NIDEN {
    #[doc = "Use DAP to enable."]
    ENABLE = 0x0,
    #[doc = "Fixed state."]
    DISABLE = 0x01,
}
impl CC_SOCU_PIN_CPU1_NIDEN {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> CC_SOCU_PIN_CPU1_NIDEN {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for CC_SOCU_PIN_CPU1_NIDEN {
    #[inline(always)]
    fn from(val: u8) -> CC_SOCU_PIN_CPU1_NIDEN {
        CC_SOCU_PIN_CPU1_NIDEN::from_bits(val)
    }
}
impl From<CC_SOCU_PIN_CPU1_NIDEN> for u8 {
    #[inline(always)]
    fn from(val: CC_SOCU_PIN_CPU1_NIDEN) -> u8 {
        CC_SOCU_PIN_CPU1_NIDEN::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum CC_SOCU_PIN_FA_CMD_EN {
    #[doc = "Use DAP to enable."]
    ENABLE = 0x0,
    #[doc = "Fixed state."]
    DISABLE = 0x01,
}
impl CC_SOCU_PIN_FA_CMD_EN {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> CC_SOCU_PIN_FA_CMD_EN {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for CC_SOCU_PIN_FA_CMD_EN {
    #[inline(always)]
    fn from(val: u8) -> CC_SOCU_PIN_FA_CMD_EN {
        CC_SOCU_PIN_FA_CMD_EN::from_bits(val)
    }
}
impl From<CC_SOCU_PIN_FA_CMD_EN> for u8 {
    #[inline(always)]
    fn from(val: CC_SOCU_PIN_FA_CMD_EN) -> u8 {
        CC_SOCU_PIN_FA_CMD_EN::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum CC_SOCU_PIN_ME_CMD_EN {
    #[doc = "Use DAP to enable."]
    ENABLE = 0x0,
    #[doc = "Fixed state."]
    DISABLE = 0x01,
}
impl CC_SOCU_PIN_ME_CMD_EN {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> CC_SOCU_PIN_ME_CMD_EN {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for CC_SOCU_PIN_ME_CMD_EN {
    #[inline(always)]
    fn from(val: u8) -> CC_SOCU_PIN_ME_CMD_EN {
        CC_SOCU_PIN_ME_CMD_EN::from_bits(val)
    }
}
impl From<CC_SOCU_PIN_ME_CMD_EN> for u8 {
    #[inline(always)]
    fn from(val: CC_SOCU_PIN_ME_CMD_EN) -> u8 {
        CC_SOCU_PIN_ME_CMD_EN::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
