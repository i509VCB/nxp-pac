...
impl defmt::Format for CC_SOCU_DFLT {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CC_SOCU_DFLT {{ NIDEN: {=bool:?}, DBGEN: {=bool:?}, SPNIDEN: {=bool:?}, SPIDEN: {=bool:?}, TAPEN: {=bool:?}, CPU1_DBGEN: {=bool:?}, ISP_CMD_EN: {=bool:?}, FA_CMD_EN: {=bool:?}, ME_CMD_EN: {=bool:?}, CPU1_NIDEN: {=bool:?}, INVERSE_VALUE: {=u16:?} }}",
            self.NIDEN(),
            self.DBGEN(),
            self.SPNIDEN(),
            self.SPIDEN(),
...
impl CC_SOCU_PIN {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn CPU1_DBGEN(&self) -> super::vals::CC_SOCU_PIN_CPU1_DBGEN {
        let val = (self.0 >> 5usize) & 0x01;
        super::vals::CC_SOCU_PIN_CPU1_DBGEN::from_bits(val as u8)
    }
    #[doc = "CPU1 (Micro cortex M33) invasive debug enable."]
    #[inline(always)]
    pub const fn set_CPU1_DBGEN(&mut self, val: super::vals::CC_SOCU_PIN_CPU1_DBGEN) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn FA_CMD_EN(&self) -> super::vals::CC_SOCU_PIN_FA_CMD_EN {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::CC_SOCU_PIN_FA_CMD_EN::from_bits(val as u8)
    }
    #[doc = "FA Command enable."]
    #[inline(always)]
    pub const fn set_FA_CMD_EN(&mut self, val: super::vals::CC_SOCU_PIN_FA_CMD_EN) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Flash Mass Erase Command enable."]
    #[must_use]
    #[inline(always)]
    pub const fn ME_CMD_EN(&self) -> super::vals::CC_SOCU_PIN_ME_CMD_EN {
        let val = (self.0 >> 8usize) & 0x01;
        super::vals::CC_SOCU_PIN_ME_CMD_EN::from_bits(val as u8)
    }
    #[doc = "Flash Mass Erase Command enable."]
    #[inline(always)]
    pub const fn set_ME_CMD_EN(&mut self, val: super::vals::CC_SOCU_PIN_ME_CMD_EN) {
        self.0 = (self.0 & !(0x01 << 8usize)) | (((val.to_bits() as u32) & 0x01) << 8usize);
    }
    #[doc = "CPU1 (Micro cortex M33) non-invasive debug enable."]
    #[must_use]
    #[inline(always)]
    pub const fn CPU1_NIDEN(&self) -> super::vals::CC_SOCU_PIN_CPU1_NIDEN {
        let val = (self.0 >> 9usize) & 0x01;
        super::vals::CC_SOCU_PIN_CPU1_NIDEN::from_bits(val as u8)
    }
    #[doc = "CPU1 (Micro cortex M33) non-invasive debug enable."]
    #[inline(always)]
    pub const fn set_CPU1_NIDEN(&mut self, val: super::vals::CC_SOCU_PIN_CPU1_NIDEN) {
...
impl defmt::Format for CC_SOCU_PIN {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CC_SOCU_PIN {{ NIDEN: {:?}, DBGEN: {:?}, SPNIDEN: {:?}, SPIDEN: {:?}, TAPEN: {:?}, CPU1_DBGEN: {:?}, ISP_CMD_EN: {:?}, FA_CMD_EN: {:?}, ME_CMD_EN: {:?}, CPU1_NIDEN: {:?}, UUID_CHECK: {=bool:?}, INVERSE_VALUE: {=u16:?} }}",
            self.NIDEN(),
            self.DBGEN(),
            self.SPNIDEN(),
            self.SPIDEN(),
...
impl defmt::Format for SECURE_BOOT_CFG {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SECURE_BOOT_CFG {{ RSA4K: {:?}, DICE_INC_NXP_CFG: {:?}, DICE_CUST_CFG: {:?}, SKIP_DICE: {:?}, TZM_IMAGE_TYPE: {:?}, BLOCK_SET_KEY: {:?}, BLOCK_ENROLL: {:?}, DICE_INC_SEC_EPOCH: {=u8:?}, SEC_BOOT_EN: {:?} }}",
            self.RSA4K(),
