...
impl DEBUG_FEATURES {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn CPU1_DBGEN(&self) -> super::vals::DEBUG_FEATURES_CPU1_DBGEN {
        let val = (self.0 >> 8usize) & 0x03;
        super::vals::DEBUG_FEATURES_CPU1_DBGEN::from_bits(val as u8)
    }
    #[doc = "CPU1 Invasive debug control:."]
    #[inline(always)]
    pub const fn set_CPU1_DBGEN(&mut self, val: super::vals::DEBUG_FEATURES_CPU1_DBGEN) {
        self.0 = (self.0 & !(0x03 << 8usize)) | (((val.to_bits() as u32) & 0x03) << 8usize);
    }
    #[doc = "CPU1 Non Invasive debug control:."]
    #[must_use]
    #[inline(always)]
    pub const fn CPU1_NIDEN(&self) -> super::vals::DEBUG_FEATURES_CPU1_NIDEN {
        let val = (self.0 >> 10usize) & 0x03;
        super::vals::DEBUG_FEATURES_CPU1_NIDEN::from_bits(val as u8)
    }
    #[doc = "CPU1 Non Invasive debug control:."]
    #[inline(always)]
    pub const fn set_CPU1_NIDEN(&mut self, val: super::vals::DEBUG_FEATURES_CPU1_NIDEN) {
...
impl defmt::Format for DEBUG_FEATURES {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "DEBUG_FEATURES {{ CPU0_DBGEN: {:?}, CPU0_NIDEN: {:?}, CPU0_SPIDEN: {:?}, CPU0_SPNIDEN: {:?}, CPU1_DBGEN: {:?}, CPU1_NIDEN: {:?} }}",
            self.CPU0_DBGEN(),
            self.CPU0_NIDEN(),
            self.CPU0_SPIDEN(),
            self.CPU0_SPNIDEN(),
...
impl DEBUG_FEATURES_DP {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn CPU1_DBGEN(&self) -> super::vals::DEBUG_FEATURES_DP_CPU1_DBGEN {
        let val = (self.0 >> 8usize) & 0x03;
        super::vals::DEBUG_FEATURES_DP_CPU1_DBGEN::from_bits(val as u8)
    }
    #[doc = "CPU1 Invasive debug control:."]
    #[inline(always)]
    pub const fn set_CPU1_DBGEN(&mut self, val: super::vals::DEBUG_FEATURES_DP_CPU1_DBGEN) {
        self.0 = (self.0 & !(0x03 << 8usize)) | (((val.to_bits() as u32) & 0x03) << 8usize);
    }
    #[doc = "CPU1 Non Invasive debug control:."]
    #[must_use]
    #[inline(always)]
    pub const fn CPU1_NIDEN(&self) -> super::vals::DEBUG_FEATURES_DP_CPU1_NIDEN {
        let val = (self.0 >> 10usize) & 0x03;
        super::vals::DEBUG_FEATURES_DP_CPU1_NIDEN::from_bits(val as u8)
    }
    #[doc = "CPU1 Non Invasive debug control:."]
    #[inline(always)]
    pub const fn set_CPU1_NIDEN(&mut self, val: super::vals::DEBUG_FEATURES_DP_CPU1_NIDEN) {
        self.0 = (self.0 & !(0x03 << 10usize)) | (((val.to_bits() as u32) & 0x03) << 10usize);
    }
}
...
impl defmt::Format for DEBUG_FEATURES_DP {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "DEBUG_FEATURES_DP {{ CPU0_DBGEN: {:?}, CPU0_NIDEN: {:?}, CPU0_SPIDEN: {:?}, CPU0_SPNIDEN: {:?}, CPU1_DBGEN: {:?}, CPU1_NIDEN: {:?} }}",
            self.CPU0_DBGEN(),
            self.CPU0_NIDEN(),
            self.CPU0_SPIDEN(),
            self.CPU0_SPNIDEN(),
...
impl PRESETCTRL0 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn SRAM_CTRL3_RST(&self) -> super::vals::SRAM_CTRL3_RST {
        let val = (self.0 >> 5usize) & 0x01;
        super::vals::SRAM_CTRL3_RST::from_bits(val as u8)
    }
    #[doc = "SRAM Controller 3 reset control."]
    #[inline(always)]
    pub const fn set_SRAM_CTRL3_RST(&mut self, val: super::vals::SRAM_CTRL3_RST) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val.to_bits() as u32) & 0x01) << 5usize);
    }
    #[doc = "SRAM Controller 4 reset control."]
    #[must_use]
    #[inline(always)]
    pub const fn SRAM_CTRL4_RST(&self) -> super::vals::SRAM_CTRL4_RST {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::SRAM_CTRL4_RST::from_bits(val as u8)
    }
    #[doc = "SRAM Controller 4 reset control."]
    #[inline(always)]
    pub const fn set_SRAM_CTRL4_RST(&mut self, val: super::vals::SRAM_CTRL4_RST) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u32) & 0x01) << 6usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn GPIO2_RST(&self) -> super::vals::GPIO2_RST {
        let val = (self.0 >> 16usize) & 0x01;
        super::vals::GPIO2_RST::from_bits(val as u8)
    }
    #[doc = "GPIO2 reset control."]
    #[inline(always)]
    pub const fn set_GPIO2_RST(&mut self, val: super::vals::GPIO2_RST) {
        self.0 = (self.0 & !(0x01 << 16usize)) | (((val.to_bits() as u32) & 0x01) << 16usize);
    }
    #[doc = "GPIO3 reset control."]
    #[must_use]
    #[inline(always)]
    pub const fn GPIO3_RST(&self) -> super::vals::GPIO3_RST {
        let val = (self.0 >> 17usize) & 0x01;
        super::vals::GPIO3_RST::from_bits(val as u8)
    }
    #[doc = "GPIO3 reset control."]
    #[inline(always)]
    pub const fn set_GPIO3_RST(&mut self, val: super::vals::GPIO3_RST) {
...
impl PRESETCTRL1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn SCTIPU_RST(&self) -> super::vals::SCTIPU_RST {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::SCTIPU_RST::from_bits(val as u8)
    }
    #[doc = "SCTIPU reset control."]
    #[inline(always)]
    pub const fn set_SCTIPU_RST(&mut self, val: super::vals::SCTIPU_RST) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u32) & 0x01) << 6usize);
    }
...
impl PRESETCTRL2 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn SDIO_RST(&self) -> super::vals::SDIO_RST {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::SDIO_RST::from_bits(val as u8)
    }
    #[doc = "SDIO reset control."]
    #[inline(always)]
    pub const fn set_SDIO_RST(&mut self, val: super::vals::SDIO_RST) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn PQ_RST(&self) -> super::vals::PQ_RST {
        let val = (self.0 >> 19usize) & 0x01;
        super::vals::PQ_RST::from_bits(val as u8)
    }
    #[doc = "Power Quad reset control."]
    #[inline(always)]
    pub const fn set_PQ_RST(&mut self, val: super::vals::PQ_RST) {
        self.0 = (self.0 & !(0x01 << 19usize)) | (((val.to_bits() as u32) & 0x01) << 19usize);
    }
...
impl SDIOCLKCTRL {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn CCLK_DRV_PHASE(&self) -> super::vals::CCLK_DRV_PHASE {
        let val = (self.0 >> 0usize) & 0x03;
        super::vals::CCLK_DRV_PHASE::from_bits(val as u8)
    }
    #[doc = "Programmable delay value by which cclk_in_drv is phase-shifted with regard to cclk_in."]
    #[inline(always)]
    pub const fn set_CCLK_DRV_PHASE(&mut self, val: super::vals::CCLK_DRV_PHASE) {
        self.0 = (self.0 & !(0x03 << 0usize)) | (((val.to_bits() as u32) & 0x03) << 0usize);
    }
    #[doc = "Programmable delay value by which cclk_in_sample is delayed with regard to cclk_in."]
    #[must_use]
    #[inline(always)]
    pub const fn CCLK_SAMPLE_PHASE(&self) -> super::vals::CCLK_SAMPLE_PHASE {
        let val = (self.0 >> 2usize) & 0x03;
        super::vals::CCLK_SAMPLE_PHASE::from_bits(val as u8)
    }
    #[doc = "Programmable delay value by which cclk_in_sample is delayed with regard to cclk_in."]
    #[inline(always)]
    pub const fn set_CCLK_SAMPLE_PHASE(&mut self, val: super::vals::CCLK_SAMPLE_PHASE) {
        self.0 = (self.0 & !(0x03 << 2usize)) | (((val.to_bits() as u32) & 0x03) << 2usize);
    }
    #[doc = "Enables the delays CCLK_DRV_PHASE and CCLK_SAMPLE_PHASE."]
    #[must_use]
    #[inline(always)]
    pub const fn PHASE_ACTIVE(&self) -> super::vals::PHASE_ACTIVE {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::PHASE_ACTIVE::from_bits(val as u8)
    }
    #[doc = "Enables the delays CCLK_DRV_PHASE and CCLK_SAMPLE_PHASE."]
    #[inline(always)]
    pub const fn set_PHASE_ACTIVE(&mut self, val: super::vals::PHASE_ACTIVE) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
...
impl SDIOCLKDIV {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn RESET(&self) -> super::vals::SDIOCLKDIV_RESET {
        let val = (self.0 >> 29usize) & 0x01;
        super::vals::SDIOCLKDIV_RESET::from_bits(val as u8)
    }
    #[doc = "Resets the divider counter."]
    #[inline(always)]
    pub const fn set_RESET(&mut self, val: super::vals::SDIOCLKDIV_RESET) {
        self.0 = (self.0 & !(0x01 << 29usize)) | (((val.to_bits() as u32) & 0x01) << 29usize);
    }
    #[doc = "Halts the divider counter."]
    #[must_use]
    #[inline(always)]
    pub const fn HALT(&self) -> super::vals::SDIOCLKDIV_HALT {
        let val = (self.0 >> 30usize) & 0x01;
        super::vals::SDIOCLKDIV_HALT::from_bits(val as u8)
    }
    #[doc = "Halts the divider counter."]
    #[inline(always)]
    pub const fn set_HALT(&mut self, val: super::vals::SDIOCLKDIV_HALT) {
        self.0 = (self.0 & !(0x01 << 30usize)) | (((val.to_bits() as u32) & 0x01) << 30usize);
    }
    #[doc = "Divider status flag."]
    #[must_use]
    #[inline(always)]
    pub const fn REQFLAG(&self) -> super::vals::SDIOCLKDIV_REQFLAG {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::SDIOCLKDIV_REQFLAG::from_bits(val as u8)
    }
    #[doc = "Divider status flag."]
    #[inline(always)]
    pub const fn set_REQFLAG(&mut self, val: super::vals::SDIOCLKDIV_REQFLAG) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
...
impl SDIOCLKSEL {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn SEL(&self) -> super::vals::SDIOCLKSEL_SEL {
        let val = (self.0 >> 0usize) & 0x07;
        super::vals::SDIOCLKSEL_SEL::from_bits(val as u8)
    }
    #[doc = "SDIO clock source select."]
    #[inline(always)]
    pub const fn set_SEL(&mut self, val: super::vals::SDIOCLKSEL_SEL) {
        self.0 = (self.0 & !(0x07 << 0usize)) | (((val.to_bits() as u32) & 0x07) << 0usize);
    }
}
...
impl SYSTICKCLKDIV1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn RESET(&self) -> super::vals::SYSTICKCLKDIV1_RESET {
        let val = (self.0 >> 29usize) & 0x01;
        super::vals::SYSTICKCLKDIV1_RESET::from_bits(val as u8)
    }
    #[doc = "Resets the divider counter."]
    #[inline(always)]
    pub const fn set_RESET(&mut self, val: super::vals::SYSTICKCLKDIV1_RESET) {
        self.0 = (self.0 & !(0x01 << 29usize)) | (((val.to_bits() as u32) & 0x01) << 29usize);
    }
    #[doc = "Halts the divider counter."]
    #[must_use]
    #[inline(always)]
    pub const fn HALT(&self) -> super::vals::SYSTICKCLKDIV1_HALT {
        let val = (self.0 >> 30usize) & 0x01;
        super::vals::SYSTICKCLKDIV1_HALT::from_bits(val as u8)
    }
    #[doc = "Halts the divider counter."]
    #[inline(always)]
    pub const fn set_HALT(&mut self, val: super::vals::SYSTICKCLKDIV1_HALT) {
        self.0 = (self.0 & !(0x01 << 30usize)) | (((val.to_bits() as u32) & 0x01) << 30usize);
    }
    #[doc = "Divider status flag."]
    #[must_use]
    #[inline(always)]
    pub const fn REQFLAG(&self) -> super::vals::SYSTICKCLKDIV1_REQFLAG {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::SYSTICKCLKDIV1_REQFLAG::from_bits(val as u8)
    }
    #[doc = "Divider status flag."]
    #[inline(always)]
    pub const fn set_REQFLAG(&mut self, val: super::vals::SYSTICKCLKDIV1_REQFLAG) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
...
impl SYSTICKCLKSEL1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn SEL(&self) -> super::vals::SYSTICKCLKSEL1_SEL {
        let val = (self.0 >> 0usize) & 0x07;
        super::vals::SYSTICKCLKSEL1_SEL::from_bits(val as u8)
    }
    #[doc = "System Tick Timer for CPU1 source select."]
    #[inline(always)]
    pub const fn set_SEL(&mut self, val: super::vals::SYSTICKCLKSEL1_SEL) {
        self.0 = (self.0 & !(0x07 << 0usize)) | (((val.to_bits() as u32) & 0x07) << 0usize);
    }
}
