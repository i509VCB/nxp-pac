...
impl defmt::Format for Hp0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Hp0 {{ hp_dma: {=bool:?}, l_dma: {=bool:?}, hp_lcdif: {=bool:?}, l_lcdif: {=bool:?}, hp_csi: {=bool:?}, l_csi: {=bool:?}, hp_pxp: {=bool:?}, l_pxp: {=bool:?}, hp_dcp: {=bool:?}, l_dcp: {=bool:?}, hp_enet: {=bool:?}, l_enet: {=bool:?}, hp_usdhc1: {=bool:?}, l_usdhc1: {=bool:?}, hp_usdhc2: {=bool:?}, l_usdhc2: {=bool:?}, hp_tpsmp: {=bool:?}, l_tpsmp: {=bool:?}, hp_usb: {=bool:?}, l_usb: {=bool:?}, hp_enet2: {:?}, l_enet2: {:?} }}",
            self.hp_dma(),
            self.l_dma(),
            self.hp_lcdif(),
            self.l_lcdif(),
...
impl defmt::Format for Hpcontrol0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Hpcontrol0 {{ hpc_dma: {=bool:?}, l_dma: {=bool:?}, hpc_lcdif: {=bool:?}, l_lcdif: {=bool:?}, hpc_csi: {=bool:?}, l_csi: {=bool:?}, hpc_pxp: {=bool:?}, l_pxp: {=bool:?}, hpc_dcp: {=bool:?}, l_dcp: {=bool:?}, hpc_enet: {=bool:?}, l_enet: {=bool:?}, hpc_usdhc1: {=bool:?}, l_usdhc1: {=bool:?}, hpc_usdhc2: {=bool:?}, l_usdhc2: {=bool:?}, hpc_tpsmp: {=bool:?}, l_tpsmp: {=bool:?}, hpc_usb: {=bool:?}, l_usb: {=bool:?}, hpc_enet2: {:?}, l_enet2: {:?} }}",
            self.hpc_dma(),
            self.l_dma(),
            self.hpc_lcdif(),
            self.l_lcdif(),
...
impl defmt::Format for Sa {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Sa {{ nsa_dma: {=bool:?}, l_dma: {=bool:?}, nsa_lcdif: {=bool:?}, l_lcdif: {=bool:?}, nsa_csi: {=bool:?}, l_csi: {=bool:?}, nsa_pxp: {=bool:?}, l_pxp: {=bool:?}, nsa_dcp: {=bool:?}, l_dcp: {=bool:?}, nsa_enet: {=bool:?}, l_enet: {=bool:?}, nsa_usdhc1: {=bool:?}, l_usdhc1: {=bool:?}, nsa_usdhc2: {=bool:?}, l_usdhc2: {=bool:?}, nsa_tpsmp: {=bool:?}, l_tpsmp: {=bool:?}, nsa_usb: {=bool:?}, l_usb: {=bool:?}, nsa_enet2: {:?}, l_enet2: {:?} }}",
            self.nsa_dma(),
            self.l_dma(),
            self.nsa_lcdif(),
            self.l_lcdif(),
