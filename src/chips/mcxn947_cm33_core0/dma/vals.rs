...
impl Edbg {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Edbg {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Edbg {
    #[inline(always)]
    fn from(val: u8) -> Edbg {
        Edbg::from_bits(val)
    }
}
impl From<Edbg> for u8 {
    #[inline(always)]
    fn from(val: Edbg) -> u8 {
        Edbg::to_bits(val)
    }
...
impl Erca {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Erca {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Erca {
    #[inline(always)]
    fn from(val: u8) -> Erca {
        Erca::from_bits(val)
    }
}
impl From<Erca> for u8 {
    #[inline(always)]
    fn from(val: Erca) -> u8 {
        Erca::to_bits(val)
    }
...
impl Gclc {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Gclc {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Gclc {
    #[inline(always)]
    fn from(val: u8) -> Gclc {
        Gclc::from_bits(val)
    }
}
impl From<Gclc> for u8 {
    #[inline(always)]
    fn from(val: Gclc) -> u8 {
        Gclc::to_bits(val)
    }
...
impl Gmrc {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Gmrc {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Gmrc {
    #[inline(always)]
    fn from(val: u8) -> Gmrc {
        Gmrc::from_bits(val)
    }
}
impl From<Gmrc> for u8 {
    #[inline(always)]
    fn from(val: Gmrc) -> u8 {
        Gmrc::to_bits(val)
    }
