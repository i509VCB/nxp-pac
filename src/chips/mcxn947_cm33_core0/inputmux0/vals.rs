...
impl CtimerCapInp {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> CtimerCapInp {
...
impl From<u8> for CtimerCapInp {
    #[inline(always)]
    fn from(val: u8) -> CtimerCapInp {
        CtimerCapInp::from_bits(val)
    }
}
impl From<CtimerCapInp> for u8 {
    #[inline(always)]
    fn from(val: CtimerCapInp) -> u8 {
        CtimerCapInp::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
