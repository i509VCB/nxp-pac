...
impl Gcr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn iref_ptat_ext_sel(&self) -> super::vals::IrefPtatExtSel {
        let val = (self.0 >> 20usize) & 0x01;
        super::vals::IrefPtatExtSel::from_bits(val as u8)
    }
    #[doc = "External On-Chip PTAT Current Reference Select"]
    #[inline(always)]
    pub const fn set_iref_ptat_ext_sel(&mut self, val: super::vals::IrefPtatExtSel) {
        self.0 = (self.0 & !(0x01 << 20usize)) | (((val.to_bits() as u32) & 0x01) << 20usize);
    }
    #[doc = "External On-Chip ZTC Current Reference Select"]
    #[must_use]
    #[inline(always)]
    pub const fn iref_ztc_ext_sel(&self) -> super::vals::IrefZtcExtSel {
        let val = (self.0 >> 21usize) & 0x01;
        super::vals::IrefZtcExtSel::from_bits(val as u8)
    }
    #[doc = "External On-Chip ZTC Current Reference Select"]
    #[inline(always)]
    pub const fn set_iref_ztc_ext_sel(&mut self, val: super::vals::IrefZtcExtSel) {
...
impl defmt::Format for Gcr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Gcr {{ dacen: {:?}, dacrfs: {:?}, fifoen: {:?}, swmd: {:?}, trgsel: {:?}, ptgen: {:?}, latch_cyc: {=u8:?}, buf_en: {:?}, iref_ptat_ext_sel: {:?}, iref_ztc_ext_sel: {:?}, buf_spd_ctrl: {:?} }}",
            self.dacen(),
            self.dacrfs(),
            self.fifoen(),
            self.swmd(),
