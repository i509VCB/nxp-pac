...
impl IrefPtatExtSel {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> IrefPtatExtSel {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for IrefPtatExtSel {
    #[inline(always)]
    fn from(val: u8) -> IrefPtatExtSel {
        IrefPtatExtSel::from_bits(val)
    }
}
impl From<IrefPtatExtSel> for u8 {
    #[inline(always)]
    fn from(val: IrefPtatExtSel) -> u8 {
        IrefPtatExtSel::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl IrefZtcExtSel {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> IrefZtcExtSel {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for IrefZtcExtSel {
    #[inline(always)]
    fn from(val: u8) -> IrefZtcExtSel {
        IrefZtcExtSel::from_bits(val)
    }
}
impl From<IrefZtcExtSel> for u8 {
    #[inline(always)]
    fn from(val: IrefZtcExtSel) -> u8 {
        IrefZtcExtSel::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
